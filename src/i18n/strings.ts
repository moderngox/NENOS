...
export const fr: Strings = {
  ...
  pricing: {
    ...
    digital: {
      ...
      features: ['24 pages illustrées', 'Téléchargement PDF', 'Lecture dans l\'application'],
      cta: 'Créer mon livre →',
    },
    hardcover: {
      name: 'Relié',
      ...
      features: ['Livre relié imprimé', '24 pages illustrées', 'Téléchargement PDF inclus', 'Lecture dans l\'application'],
      cta: 'Créer mon livre →',
    },
    subscription: {
      name: 'Abonnement',
...
export const en: Strings = {
  ...
  pricing: {
    ...
    digital: {
      ...
      features: ['24 illustrated pages', 'PDF download', 'In-app reading'],
      cta: 'Create my book →',
    },
    hardcover: {
      name: 'Hardcover',
      ...
      features: ['Printed hardcover book', '24 illustrated pages', 'PDF download included', 'In-app reading'],
      cta: 'Create my book →',
    },
    subscription: {
      name: 'Subscription',
